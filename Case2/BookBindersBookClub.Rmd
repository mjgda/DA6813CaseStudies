...
bbtrain.over$Choice <- factor(bbtrain.over$Class, levels=rev(levels(bbtrain.over$Class)))
...
predlog_over<-as.factor(ifelse(predlog_over>0.5,0,1))
...
predlog_rose<-as.factor(ifelse(predlog_rose>0.5,0,1))
