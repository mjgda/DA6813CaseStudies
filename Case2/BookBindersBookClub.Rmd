...
The main reason for sending the brochure through the mail is to find the potential buyers to buy the book, so the model which will predict the customers will not buy the book is not useful and also it will impact the book binders club profitability by sending the brochure to the more people who will not buy the book.
...
As a result, the models yielding the highest profitability were trained on the ROSE dataset, and of those the model with the highest performance is the logistic regression, **/////
...
Interestingly, the attributes that made it less likely for a customer to buy the book were being female, or having purchased books other than art books.
