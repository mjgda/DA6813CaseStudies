...
We can also see the effect each of these variables has on the target variables of acquisition and duration by plotting partial dependence of these variables.
```{r}
for(i in acq_vars){
