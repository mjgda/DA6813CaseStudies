...
```{r echo=F}
predictions<-list(predlog,predlogfull,predtree,predtreefull,predrad,predrf,predrffull)
...
legend("topleft",legend=c("Full Logistic Regression","Personal LogReg","Personal Random Forest","Full Random Forest","Linear SVM","Full Decision Tree","Personal Decision Tree","Break-even Profitability"),lty=c(1,1,1,2,2,1,1,3),lwd = 2,col = c("orange", "darkblue","blue","blue","red","green","black","black"))
```
